...
{\huge \bfseries La réalisation d'un classificateur NLP hybride entre le machine learning et le deep learning .}\\[0.4cm] % Thesis title
...
\input{Chapters/ContexteGenerale}
\input{Chapters/AnalyseConception}
